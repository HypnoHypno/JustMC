...
default persistent.lockdown_warning = True
...
label attempt_restore:
    scene black
    python:
        run_input(input="restore_character([[\"sayori\"])", output="Failed to restore character.")
        pause( 0.25 )
        run_input(input="restore_character([[\"yuri\"])", output="Failed to restore character.")
        pause( 0.5 )
        run_input(input="restore_character([[\"natsuki\"])", output="Failed to restore character.")
        pause( 0.75 )
        run_input(input="restore_character([[\"monika\"])", output="Failed to restore character.")
        pause( 1 )
    jump restore_mc

label restore_mc:
    python:
        run_input(input='VM.locate_personality_files()', output="Locating personality files...")
        pause(3)
        run_input(input='', output="1 personality file(s) located.")
        run_input(input='', output="Generate character file(s)? [[Y/N]")
        run_input(input='Y                                        ', output="Generating character file 1/1...")
        pause(2)
        run_input(input='', output="Complete.") # TODO: Make it actually make MC.chr
        pause(1)
        run_input(input='VM.utter_restart()', output="Restarting VM...")
        pause(3)
